...
const Sidebar = () => {
  ...
  const wrapperClass = classNames(
    "h-screen px-4 pt-8 pb-4  bg-white flex justify-between flex-col border-r border-gray-100 overflow-y-hidden overscroll-auto",
    {
      ["w-80"]: !toggleCollapse,
      ["w-20"]: toggleCollapse,
    }
  ...
  return (
    <div
      ...
      style={{ transition: "width 300ms cubic-bezier(0.2, 0, 0, 1) 0s", overflowY: "hidden" }}
    >
