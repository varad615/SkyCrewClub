...
const menuItems = [
  ...
  { id: 2, label: "Interactive Course", icon: RiCompassFill, link: "/course-manager" },
...
const Sidebar = () => {
  ...
  const wrapperClass = classNames(
    "h-screen px-4 pt-8 pb-4 bg-slate-50 flex justify-between flex-col border-r border-gray-100 overflow-y-hidden",
    {
      ["w-80"]: !toggleCollapse,
      ["w-20"]: toggleCollapse,
    }
